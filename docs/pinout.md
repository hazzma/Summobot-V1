...
| **Line IR Belakang-Kiri**| `LINE_BL` | **GPIO 36** | Input Only | Tidak ada pull-up internal; butuh external pull-up |
| **Line IR Belakang-Kanan**| `LINE_BR`| **GPIO 39** | Input Only | Tidak ada pull-up internal; butuh external pull-up |
...
3. **Input-Only Pins (GPI):**  
   **GPIO 34, 35, 36, 39** tidak memiliki sirkuit output dan tidak memiliki resistor pull-up/pull-down internal software. Sangat cocok digunakan untuk sensor input aktif seperti sensor garis IR dengan modul komparator eksternal.
4. **UART0:**  
...
#define HAS_LINE_IR    0  // 1 jika 4 sensor garis IR dipasang di GPIO 34, 35, 36, 39
