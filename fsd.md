...
| `LINE_FR` | **23** | Digital In (pull capable) | Sudut Depan-Kanan (deteksi garis putih, dipindah dari GPIO 35) |
...
- **Flip `HAS_LINE_IR` to `1`** once the 4-sensor line array is wired (reserved GPIO 34, 23, 14, 13) — activates corner-aware edge avoidance.
